...
`nirs4all` is part of the **nirs4all ecosystem** and is offered under a
...
for example, embedding `nirs4all` in a **proprietary, closed-source product or SaaS**
...
`nirs4all` relies on third-party open-source components. Their licenses are summarized
