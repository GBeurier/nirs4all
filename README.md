...
# Verified native Methods training, full refit, and Archive V2/V3 replay
...
sessions, strict Methods HPO, Archive V2 export/load, target-bound Archive V3
full-refit export/load, and replay. It does not
