...
Canonical location after the synthesis bench reorganization:
`bench/synthesis/nirs_synthetic_pfn`.

Legacy commands using `bench/nirs_synthetic_pfn` still work through a
