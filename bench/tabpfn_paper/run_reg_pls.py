...
from nirs4all.operators.splitters.splitters import SPXYGFold, SPXYFold
...
DATASETS = [
	# 'AMYLOSE/Rice_Amylose_313_YbasedSplit', # PLS 1.85 - TabPFN: 1.31 +
            ...
            # 'ALPINE/ALPINE_N_552_KS',
            'LUCAS/LUCAS_SOC_Cropland_8731_NocitaKS',
            ...
            'LUCAS/LUCAS_SOC_all_26650_NocitaKS',
            ...
            # 'ALPINE/ALPINE_C_424_RobustnessAlps',
