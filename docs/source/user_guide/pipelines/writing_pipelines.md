...
### 4. `_or_` with `pick` Range - Variable Pick
...
**Expands to**: All combinations picking 1 + all combinations picking 2 = 4 + 6 = 10 pipelines.
...
**Syntax**: Use list `[outer_pick, inner_pick]` for nested combinations (sub-pipelines).
