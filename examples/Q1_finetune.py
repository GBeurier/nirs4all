...
pipeline = [
    ...
    splitting_strategy,
    {
        ...
        "finetune_params": {
            ...
            "approach": "single",  # "grouped" - best or average params over folds, "individual" - one best param per folds, "single" - no folds
            "eval_mode": "best",     # "best" to use the best trial, "avg" to average all trials. Only for "grouped" approach
