...
def test_core_dataset_features():
    ...
    print("1. Testing SpectraDataset with string classification targets...")
      # Create sample data (2D arrays: samples x features)
    features = [np.random.randn(10, 100)]  # 10 samples, 100 features each
    ...
    regression_features = [np.random.randn(8, 100)]  # 8 samples, 100 features each
    ...
    features2 = [np.random.randn(5, 100)]  # 5 samples, 100 features each
