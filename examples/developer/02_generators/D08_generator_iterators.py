"""
D08 - Generator Iterators: Programmatic Generator Access
=========================================================
...
- D07_generator_advanced for constraints

Next Steps
----------
See D09_nested_generators for complex nested patterns.
...
parser = argparse.ArgumentParser(description='D08 Generator Iterators Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("D08 - Generator Iterators: Programmatic Generator Access")
print("=" * 60)
...
Next: D09_nested_generators.py - Complex nested patterns
""")
