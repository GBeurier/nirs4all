"""
D01 - PyTorch Models: Deep Learning with PyTorch
=================================================
...
Next Steps
----------
See D02_jax_models for JAX/Flax integration.
...
parser = argparse.ArgumentParser(description='D01 PyTorch Models Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("D01 - PyTorch Models: Deep Learning Integration")
print("=" * 60)
...
Next: D02_jax_models.py - JAX/Flax integration
""")
