"""
D13 - Framework Comparison: TensorFlow vs PyTorch vs JAX
=========================================================
...
Prerequisites
-------------
- D10_pytorch_models, D11_jax_models, D12_tensorflow_models

Next Steps
----------
See D14_transfer_analysis for calibration transfer.
...
parser = argparse.ArgumentParser(description='D13 Framework Comparison Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("D13 - Framework Comparison: TF vs PyTorch vs JAX")
print("=" * 60)
...
Next: D14_transfer_basics.py - Calibration transfer
""")
