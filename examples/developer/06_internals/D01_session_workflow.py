"""
D01 - Session Workflow: Managing Pipeline Sessions
===================================================
...
Next Steps
----------
See D02_custom_controllers for extending the controller system.
...
parser = argparse.ArgumentParser(description='D01 Session Workflow Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("D01 - Session Workflow: Managing Pipeline Sessions")
print("=" * 60)
...
Next: D02_custom_controllers.py - Extending the controller system
""")
