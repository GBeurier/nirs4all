"""
U07 - Multi-Source: Combining NIR with Other Data Sources
==========================================================
...
Prerequisites
-------------
Complete :ref:`U06_multi_datasets` first.

Next Steps
----------
See :ref:`U08_wavelength_handling` for wavelength interpolation and units.
...
parser = argparse.ArgumentParser(description='U07 Multi-Source Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("U07 - Multi-Source Data Handling")
print("=" * 60)
...
Next: U08_wavelength_handling.py - Wavelength interpolation and units
""")
