"""
U09 - Preprocessing Basics: NIRS-Specific Transformations
==========================================================
...
Next Steps
----------
See :ref:`U10_feature_augmentation` for preprocessing exploration.
...
parser = argparse.ArgumentParser(description='U09 Preprocessing Basics Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("U09 - NIRS Preprocessing Techniques")
print("=" * 60)
...
Next: U10_feature_augmentation.py - Automated preprocessing exploration
""")
