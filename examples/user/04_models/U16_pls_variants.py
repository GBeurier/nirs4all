"""
U16 - PLS Variants: Specialized Partial Least Squares Methods
==============================================================
...
Next Steps
----------
See :ref:`U17_cv_strategies` for cross-validation methods.
...
parser = argparse.ArgumentParser(description='U16 PLS Variants Example')
...
Next: U17_cv_strategies.py - Cross-validation strategies
""")
