"""
U17 - Cross-Validation Strategies: Choosing the Right CV Method
================================================================
...
Next Steps
----------
See :ref:`U18_group_splitting` for grouped data.
...
parser = argparse.ArgumentParser(description='U17 CV Strategies Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("U17 - Cross-Validation Strategies")
print("=" * 60)
...
Next: U18_group_splitting.py - Handle grouped/clustered data
""")
