"""
U21 - Save, Load, and Predict: Model Persistence
=================================================
...
Next Steps
----------
See :ref:`U22_export_bundle` for portable model export.
...
parser = argparse.ArgumentParser(description='U21 Save Load Predict Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("U21 - Save, Load, and Predict")
print("=" * 60)
...
Next: U22_export_bundle.py - Export portable model bundles
""")
