"""
U22 - Export Bundle: Portable Model Deployment
===============================================
...
Prerequisites
-------------
Complete :ref:`U21_save_load_predict` first.

Next Steps
----------
See :ref:`U23_workspace_management` for session handling.
...
parser = argparse.ArgumentParser(description='U22 Export Bundle Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("U22 - Export Bundle: Portable Model Deployment")
print("=" * 60)
...
Next: U23_workspace_management.py - Session and workspace handling
""")
