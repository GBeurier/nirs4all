"""
U23 - Workspace Management: Sessions and Organization
======================================================
...
Prerequisites
-------------
Complete :ref:`U22_export_bundle` first.

Next Steps
----------
See :ref:`U24_sklearn_integration` for sklearn compatibility.
...
parser = argparse.ArgumentParser(description='U23 Workspace Management Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("U23 - Workspace Management: Sessions and Organization")
print("=" * 60)
...
Next: U24_sklearn_integration.py - sklearn Pipeline compatibility
""")
