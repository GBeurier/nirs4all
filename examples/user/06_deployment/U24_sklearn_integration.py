"""
U24 - sklearn Integration: NIRSPipeline Wrapper
================================================
...
Prerequisites
-------------
Complete :ref:`U23_workspace_management` first.

Next Steps
----------
See :ref:`U25_shap_basics` for model explainability.
...
parser = argparse.ArgumentParser(description='U24 sklearn Integration Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("U24 - sklearn Integration: NIRSPipeline Wrapper")
print("=" * 60)
...
Next: U25_shap_basics.py - Model explainability with SHAP
""")
