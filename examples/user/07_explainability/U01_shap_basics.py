"""
U01 - SHAP Basics: Model Explainability
=======================================
...
Prerequisites
-------------
Complete :ref:`06_deployment/U04_sklearn_integration` first.
Requires: pip install shap

Next Steps
----------
See :ref:`U02_shap_sklearn` for SHAP with sklearn wrapper.
...
# =============================================================================
print("\n" + "=" * 60)
print("U01 - SHAP Basics: Model Explainability")
print("=" * 60)
...
pipeline_config = PipelineConfigs(pipeline, "U01_SHAP")
...
Next: U02_shap_sklearn.py - SHAP with sklearn wrapper
""")
