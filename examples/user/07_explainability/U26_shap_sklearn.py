"""
U26 - SHAP with sklearn Wrapper: Advanced Analysis
===================================================
...
Prerequisites
-------------
Complete :ref:`U25_shap_basics` first.
Requires: pip install shap

Next Steps
----------
See :ref:`U27_feature_selection` for wavelength selection.
...
parser = argparse.ArgumentParser(description='U26 SHAP sklearn Example')
...
# =============================================================================
print("\n" + "=" * 60)
print("U26 - SHAP with sklearn Wrapper")
print("=" * 60)
...
Next: U27_feature_selection.py - Wavelength selection methods
""")
