...
class VGG:
    ...
    def VGG11(self):
        ...
        x = tf.keras.layers.MaxPooling1D(pool_size=1, strides=2, padding="valid")(x) if x.shape[1] <= 2 else tf.keras.layers.MaxPooling1D(pool_size=2, strides=2, padding="valid")(x)
