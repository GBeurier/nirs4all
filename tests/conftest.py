...
# =============================================================================
# Backward Compatibility / Deprecation Support
# =============================================================================
...
def legacy_data_generator():
    ...
    This fixture provides backward compatibility during migration.
    It will be removed in a future version.

    Returns:
        SyntheticNIRSDataGenerator: Legacy generator instance.
    """
    import warnings
    warnings.warn(
        "legacy_data_generator fixture is deprecated. "
        "Use synthetic_builder_factory or standard_*_dataset fixtures instead.",
        DeprecationWarning,
        stacklevel=2
    )
...
@pytest.fixture
def legacy_test_data_manager(tmp_path):
    """
    DEPRECATED: Use synthetic_dataset_folder instead.

    This fixture provides backward compatibility during migration.

    Returns:
        TestDataManager: Legacy test data manager.
    """
    import warnings
    warnings.warn(
        "legacy_test_data_manager fixture is deprecated. "
        "Use synthetic_dataset_folder or synthetic_builder_factory instead.",
        DeprecationWarning,
        stacklevel=2
    )
    from tests.fixtures.data_generators import TestDataManager
    return TestDataManager(base_temp_dir=str(tmp_path))
