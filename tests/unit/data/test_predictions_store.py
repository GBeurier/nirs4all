...
class TestPredictionsTop:
    ...
    def test_top_5_returns_correct_ranking(self):
        ...
        top_5 = preds.top(5, rank_metric="", rank_partition="val", ascending=True, score_scope="folds")
...
class TestResultBestScore:
    ...
    def test_best_rmse_from_buffer(self):
        ...
        best = preds.get_best(metric="", ascending=True, score_scope="folds")
    ...
    def test_top_with_precomputed_scores(self):
        ...
        results = preds.top(1, rank_partition="val", rank_metric="rmse", score_scope="folds")
        assert len(results) == 1
        assert results[0]["rank_score"] == 0.99

        results_r2 = preds.top(1, rank_partition="val", rank_metric="r2", score_scope="folds")
