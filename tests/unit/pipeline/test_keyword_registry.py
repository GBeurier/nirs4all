...
EXPECTED_PUBLISHED_REGISTRY_SHA256 = "ee987eec467523d31def7e55baeeced73caad9f9a61d522f7aa36a06147a05f8"
...
def test_execution_engine_and_optimizer_engines_are_distinct() -> None:
    ...
    assert execution_engine["engine_support"]["native"] == "partial"
    assert execution_engine["engine_support"]["dual"] == "partial"
    assert "bounded native-first, no-fallback oracle" in execution_engine["summary"]
